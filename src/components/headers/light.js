...
export const NavLink = tw.a`
  ...
  font-medium tracking-wide transition duration-300 text-gray-500
...
export const MobileNavLinks = motion(styled.div`
  ${tw`lg:hidden z-10 fixed top-0 inset-x-0 mx-4 my-6 p-8  text-center rounded-lg text-gray-500 bg-white`}
  ${NavLinks} {
