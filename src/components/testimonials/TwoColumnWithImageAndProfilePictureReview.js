...
const Subheading = tw(SubheadingBase)`mb-4 text-primary-700`;
const HeadingTitle = tw(SectionHeading)`lg:text-left leading-tight font-normal text-left text-3xl sm:text-4xl lg:text-5xl text-center md:text-left`;
...
const QuotesRight = tw(QuotesRightIcon)`w-6 h-6 opacity-75 text-secondary-500 inline-block ml-1 -mt-3`;
  ...
  const defaultTestimonials = [
    {
      ...
      customerName: "Saheed Shittu",
      customerTitle: "Co-founder, DEVPRO ACADEMY."
    },
    {
      imageSrc:
