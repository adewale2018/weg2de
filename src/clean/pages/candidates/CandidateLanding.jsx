...
function CandidateLanding({
  ...
  primaryButtonText = "info@weg2de.com",
    ...
    <Container>
      <TwoColumn>
        ...
        <TextColumn textOnLeft={textOnLeft}>
          <TextContent>
            <MainHeading>Your Pathway to <HighlightedText>Education</HighlightedText> Education and <HighlightedText>Career opportunities</HighlightedText> in Germany!</MainHeading>
